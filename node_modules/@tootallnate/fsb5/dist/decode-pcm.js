 ...
 */
export function decodeSampleToPcm16(sample, mode) {
    switch (mode) {
        case 1:
        ...
        default:
            throw new Error(`fsb5: codec ${mode} not supported by decodeSampleToPcm16`);
    }
}
function decodePcm8(s) {
 ...
 */
export function encodeWavBlob(pcm, channels, sampleRate) {
...
//# sourceMappingURL=decode-pcm.js.map